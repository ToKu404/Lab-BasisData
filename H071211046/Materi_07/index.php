...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($nim && $nama && $alamat && $fakultas) {
        if ($op == 'edit') { //untuk update
             $sql0 = "select * from mahasiswa where nim = '$nim'";
            $q0 = mysqli_query($koneksi, $sql0);
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row">
                                    <a href="index.php?op=edit&id=<?php echo $id ?>"><button type="button" class="btn" style="background-color: #87CEFA;">Edit</button></a>
                                    <a href="index.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn" style="background-color: #FFFFE0;">Delete</button></a>            
                                </td>
                            </tr>
                        <?php
                        }
